...
function characterCardData(c){const en=getLanguage()==='en';return {lines:en?[c.epithet_en||'',c.name_en||c.character_id,c.name_ja||'']:[c.epithet_ja||'',c.name_ja||c.character_id]}}
